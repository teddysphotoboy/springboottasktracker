...
public class TaskController {
    ...
    public ResponseEntity<Task> createTask(@PathVariable String projectId,@PathVariable String userId, @RequestBody TaskDTO dto,@RequestHeader("Authorization") String authHeader){
        Task task=service.createTask(dto);
        return new ResponseEntity<>(task,HttpStatus.CREATED);
    }
    @PutMapping("/update-task/{taskId}/{userId}/{projectId}")
    public void updateTask(@PathVariable String taskId,@PathVariable String userId,@PathVariable String projectId, @RequestBody TaskDTO dto,@RequestHeader("Authorization") String authHeader){
        service.updateTask(taskId,userId,projectId,dto);

    }

    @GetMapping("/{projectId}/tasks")
    public List<Task> getProjectTasks(@PathVariable String projectId,@RequestHeader("Authorization") String authHeader){
    ...
    @Transactional
    public ResponseEntity<String> deleteProjectTasks(@PathVariable String taskId,@PathVariable String userId,@PathVariable String projectId,@RequestHeader("Authorization") String authHeader){
